...
$(ColorBWhite '—————————————————————————————————————————————————————————————————————————')"
read -r -p "$(ColorBWhite 'Would you like to check for system updates?') [y/n] " response
...
case "$response" in
    [yY][eE][sS]|[yY]) 
        ...
        sleep 0.5
        echo -e $(ColorBWhite 'This script is going to start the Debian 12 installer.')
        sleep 1.5
        bash install/base.sh
        ;;
    *)
        echo -e "$(ColorBRed 'Exiting. It is recommended you update your system before installing any drivers.')"
        sleep 2.5
        ;;
esac
